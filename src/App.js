      ...
      <div id = "topBar" className = "disgrid">
        <div id = "tB-sectionOne" className = "disgrid">
          ...
          <div id = "sO-rightDiv" className = "disflex">
            <li>
              ...
              <ul id = "cartBtn" className = "font-sizesml-n padding-small margin-left-l"><i className="fa fa-shopping-cart" aria-hidden="true"> <p> Cart</p></i></ul>
        ...
        <div id = "tB-sectionThree" className = "disgrid Vcenter">
            ...
            <li id = "sT-navbar" className = "disgrid">
              <ul id = "sT-home" className = "font-sizesml disflex Vcenter"><b>HOME</b></ul>
              <ul id = "sT-store" className = "font-sizesml disflex Vcenter"><b>STORE</b></ul>
              <ul id = "sT-iphone" className = "font-sizesml disflex Vcenter"><b>IPHONE</b></ul>
              <ul id = "sT-ipad" className = "font-sizesml disflex Vcenter"><b>IPAD</b></ul>
              <ul id = "sT-macbook" className = "font-sizesml disflex Vcenter"><b>MACBOOK</b></ul>
              <ul id = "sT-accesories" className = "font-sizesml disflex Vcenter"><b>ACCESORIES</b></ul>
            </li>
            <div className = "FILLER-DIV"></div>
        </div>
      </div>
